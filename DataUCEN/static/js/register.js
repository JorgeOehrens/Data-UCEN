...
//   if (showPasswordToggle2.textContent === "Mostrar") {
//     showPasswordToggle2.textContent = "Esconder";
//     passwordField2.setAttribute("type", "text");
//   } else {
//     showPasswordToggle2.textContent = "Mostrar";
//     passwordField2.setAttribute("type", "password");
//   }
// };
// showPasswordToggle2.addEventListener("click", handleToggleInput2);

//identificacion de email


emailField.addEventListener("keyup", (e) => {
    const emailVal = e.target.value;
    usernameSuccesOut.textContent ="Checking"
